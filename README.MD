Конечно. Вот полная, финальная версия README.md без каких-либо сокращений, с четким разделением на два независимых способа установки и всеми необходимыми инструкциями.
